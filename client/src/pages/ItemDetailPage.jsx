...
function ItemDetailPage() {
  ...
  const [editing, setEditing] = useState(false); // Added state for editing
...
//Handling submission form for editing the post
              ...
              {editing ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <input
                    ...
                    onChange={(e) => setItem({ ...item, locationFound: e.target.value })}
                  />
                  ...
                  <input
                    ...
                    onChange={(e) => setItem({ ...item, timeFound: e.target.value })}
                  />
